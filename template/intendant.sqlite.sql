...
INSERT INTO "authorization_profile" ("id","authorization","profile") VALUES (5,1,1),
 ...
 (64,60,1),
 (65,61,1);
INSERT INTO "espace" ("id","reference","name","description","icon") VALUES (1,'Light','Éclairage','Modifier les lumières dune pièce','bulb-outline'),
 (2,'Weather','Météo','Récupérer les informations intérieur et extérieur ','umbrella-outline'),
 (3,'Security','Sécurité','Activer la sécurité dune application','shield-outline'),
 (4,'Environment','Environnement','Gestion de lenvironnement','droplet-outline'),
...
INSERT INTO "profile" ("id","name") VALUES (1,'admin'),
 (2,'guest'),
 (3,'occupant');
INSERT INTO "smartobject_status" ("id","name","icon") VALUES (1,'En ligne','flash'),
 (2,'Hors ligne','flash-off'),
 (3,'Smartobject inconnu','alert-triangle');
INSERT INTO "widget_content_type" ("id","reference","name","rank") VALUES (1,'title','Title',1),
 (2,'content','Content',2),
 (3,'list','List',3);
COMMIT;
