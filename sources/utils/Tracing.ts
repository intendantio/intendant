...
class Tracing {
    ...
    static welcome() {
        Tracing.pure("" +
            ...
            "")
        Tracing.pure("           Version: " + Package.version)
        Tracing.pure("")
        return true
    }
    ...
    static write(type,object,message) {
        fs.appendFileSync("./intendant.log",JSON.stringify({date: require('moment').valueOf(), type: type, object:object, message: message }) + "\n")
    }
