...
class Smartobject extends Controller {
    ...
    async getAllPackage() : Promise<Result> {
        try {
    ...
    async install(pPackage) : Promise<Result> {
        try {
    ...
    async getAllByRoom(idRoom) : Promise<Result> {
        try {
            let pSmartObjects = []
    ...
    async getOne(idSmartobject) : Promise<Result> {
        try {
    ...
    async getStatus(idSmartobject, settings = {}) : Promise<Result> {
        try {
    ...
    async updateLastUse(idSmartobject) : Promise<Result> {
        try {
            let result = await this.sqlSmartobject.updateAll({ last_use: require('moment')().valueOf() }, { id: idSmartobject })
            if (result.error) {
                return result
            }
            return new Result(Package.name, false, "")
    ...
    async updateStatus(idSmartobject, status) : Promise<Result> {
        try {
    ...
    async updateRoom(idSmartobject, idRoom) : Promise<Result> {
        try {
    ...
    async updatePosition(idSmartobject, idPosition) : Promise<Result> {
        try {
    ...
    async updateArgument(idSmartobject, reference, value) : Promise<Result> {
        try {
    ...
    async updateReference(idSmartobject, reference) : Promise<Result> {
        try {
    ...
    async insert(reference, pModule, room, settings) : Promise<Result> {
        try {
            ...
            if (smartobject) {
                ...
                let data = { module: pModule, status: 2, reference: reference, last_use: require('moment')().valueOf(), room: room }
    ...
    async regenerate(idSmartobject, settings) : Promise<Result> {
        try {
            for (let index = 0; index < settings.length; index++) {
                let setting = settings[index]
    ...
    async delete(idSmartobject) : Promise<Result> {
        try {
    ...
    async executeAction(idSmartobject, idAction, settings = {}, idProfile = false) : Promise<Result> {
        try {
    ...
    async getAllHistory(idSmartobject) : Promise<Result> {
        try {
    ...
    async getSyncData() : Promise<Result> {
    ...
    async getSyncQuery(settings = {}) : Promise<Result> {
    ...
    async getSyncExecute(settings = { inputs: [] }) : Promise<Result> {
