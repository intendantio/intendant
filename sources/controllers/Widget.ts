...
class Widget extends Controller {
    ...
    async getOne(idSmartobject, idWidget): Promise<Result> {
        try {
    ...
    getAllActions(idSmartobject): Result {
        try {
    ...
    getAllDataSources(idSmartobject): Result {
        try {
            if (this.smartobjectManager.instances.has(parseInt(idSmartobject))) {
                let instance = this.smartobjectManager.instances.get(parseInt(idSmartobject))
    ...
    getAllWidgets(idSmartobject): Result {
        try {
            if (this.smartobjectManager.instances.has(parseInt(idSmartobject))) {
                let instance = this.smartobjectManager.instances.get(parseInt(idSmartobject))
    ...
    getConfiguration(pModule): Result {
        try {
    ...
    async getDataSourceValue(idSmartobject, idDataSource): Promise<Result> {
        try {
            ...
            if (action.id != "unknown") {
                ...
                action.settings.forEach(setting => {
                    if (action.settings[setting.id] == undefined) {
    ...
    getDataSource(idSmartobject, idDataSource): Result {
        try {
