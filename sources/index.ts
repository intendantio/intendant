...
interface Manager {
    smartobject: SmartobjectManager,
...
class Core {
    ...
    constructor() {
        ...
        /* Manager */
        this.manager = {
            smartobject: new SmartobjectManager(this),
            module: new ModulesManager(this),
            automation: new AutomationManager(),
            rapport: new RapportManager(this)
        }
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                Tracing.verbose(Package.name,"Start Network manager")
                this.api = new API(this)
                Tracing.verbose(Package.name,"Start Smartobject manager")
                this.manager.smartobject.before()
                setTimeout(() => {
                    Tracing.verbose(Package.name,"Start Rapport manager")
