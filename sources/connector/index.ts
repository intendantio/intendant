...
class Connector {
    ...
    async getOneByField(wheres) {
        ...
        if (typeof wheres == 'object') {
            ...
            Tracing.warning(Package.name,"Wheres must be an object at " + this._name + ":getOneByField")
    ...
    async getAllByField(wheres = {}) {
        ...
        if (typeof wheres == 'object') {
            ...
            Tracing.warning(Package.name,"Wheres must be an object at " + this._name + ":getAllByField")
    ...
    async count(wheres = {}) {
        ...
        if (typeof wheres == 'object') {
            ...
            Tracing.warning(Package.name,"Wheres must be an object at " + this._name + ":count")
    ...
    async deleteAllByField(wheres) {
        ...
        if (typeof wheres == 'object') {
            ...
            Tracing.warning(Package.name,"Wheres must be an object at " + this._name + ":deleteAllByField")
    ...
    async updateAll(sets = {}, wheres = {}) {
        ...
        if (typeof wheres == 'object' && typeof sets == 'object') {
            ...
            Tracing.warning(Package.name,"Wheres or Sets must be an object at " + this._name + ":updateAll")
    ...
    async insert(sets) {
        ...
        if (typeof sets == 'object') {
            ...
            Tracing.warning(Package.name,"Sets must be an object at " + this._name + ":insert")
