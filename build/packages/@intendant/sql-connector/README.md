<h1 align="center">Welcome to Intendant - @intendant/sql-connector 👋</h1>
<p>
  <a href="https://www.npmjs.com/package/@intendant/sql-connector" target="_blank">
    <img alt="Version" src="https://img.shields.io/npm/v/@intendant/sql-connector.svg">
  </a>
...
```sh
npm install @intendant/sql-connector
```
